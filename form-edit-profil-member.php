...
<?php 
    ...
    <form action="#" method="POST" name="form-edit-profil-member" enctype="multipart/form-data">
        <input type="button" value="Kembali" onclick=location.hred="home-member.php" title="Kembali">
        ...
        <tr height="46">
            <td>&nbsp;</td>
            <td>Jenis Kelamin</td>
            <td>:&nbsp;<input type="radio" name="jenis_kelamin" value="L" <?php echo($jenis_kelamin=='L')?"checked":"";  ?>>Laki-laki &nbsp;&nbsp; <input type="radio" name="jenis_kelamin" value="P" <?php echo($jenis_kelamin=='P')?"checked":""; ?>>Perempuan</td>
        </tr>
        <tr height="46">
            <td>&nbsp;</td>
            <td>Pekerjaan</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;&nbsp; MAAF, PROSES INI HANYA DAPAT BERJALAN DI APLIKASI VERSI PRO, SILAHKAN HUBUNGI ADMIN!</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td height="32">&nbsp;</td>
