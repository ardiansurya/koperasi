                ...
                <td width="944">
                    <div class="nav">
                        <ul>
                            ...
                            <li><a href="home-member.php?page=lihat-tabungan-member&username=<?=$_SESSION['username']?>" title="Tabungan"><u>T</u>abungann</a></li>
                ...
                <td rowspan="4" valign="top">
                    <table width="938" height="auto" bgcolor="white" border="0" cellspacing="0" cellpadding="0">
                        <tr height="36" width="938">
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<u><strong><?php echo "Tanggal : ".date("d-M-y");?></strong></u></td>
                        </tr>
                        <tr>
