...
<body>
    <table width="964" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="964" bgcolor="#B0C4DE"> 
                <img src="image/header.png" width="964" height="130">
            </td>
        </tr>
    </table>
        ...
        <td width="944">
            <div class="nav">
                <ul>
                    ...
                    <li><a class="kananlogin" href="index.php?page=form-login" title="Login"><u>L</u>ogin</a></li>
                </ul>
            </div>
        </td>
        <td width="10">&nbsp;</td>
