<div style="border:0; padding:10px; width:924px; height:auto;">
    ...
    <form action="#" method="POST" name="profil-member" enctype="multipart/form-data">
        ...
        <input type="button" value="Edit" onclick=location.href="home-member.php?page=form-edit-profil-member&username=<?=$username?>" title="Edit">
        ...
        <tr height="46">
            <td>&nbsp;</td>
            <td>Username</td>
            <td>&nbsp;<?=$username?><input type="hidden" name="husername" value="<?=$username?>" disabled="disabled"></td>
        </tr>
        <tr height="46">
            <td>&nbsp;</td>
            <td>Nama Member</td>
